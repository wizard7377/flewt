    ...
    let rec compare =
      ...
      | ({ sd = k1; ind = None; c = c1; m = m1; r = r1; p = p1; ind = None;
         ...
         { sd = k2; ind = None; c = c2; m = m2; r = r2; p = p2; ind = None;
          ...
          ->
          (begin match ((Int.compare ((c1 * m2), (c2 * m1))),
      ...
      | ({ sd = k1; ind = None; c = c1; m = m1; r = r1; p = p1; ind = None;
         ...
         { sd = k2; ind = Some i2; c = c2; m = m2; r = r2; p = p2;
          ...
          ->
          (begin match Int.compare ((c1 * m2), (c2 * m1)) with
           | LESS -> LESS
           | EQUAL -> GREATER
           | GREATER -> GREATER end)
    ...
    | ({ sd = k1; ind = Some i1; c = c1; m = m1; r = r1; p = p1;
       ...
       { sd = k2; ind = Some i2; c = c2; m = m2; r = r2; p = p2;
        ...
        (begin match ((Int.compare ((c1 * m2), (c2 * m1))),
         ...
         | (result, _, _, _, _) -> result end) end
let rec recToString = begin function | 0 -> "non-rec" | 1 -> "rec" end
