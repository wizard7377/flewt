...
module RedBlackTree(RedBlackTree:sig
  ...
  *)
      ...
      (* re-color *)(* re-color *)(* function below from .../smlnj-lib/Util/int-redblack-set.sml *)
      (* Need to check and improve some time *)(* Sun Mar 13 08:22:53 2005 -fp *)
      ...
      (* bbZip propagates a black deficit up the tree until either the top
         ...
         *)
      (* case 1L *)(* case 3L *)(* case 3L *)
      (* case 4L *)(* case 4L *)(* case 2L *)
      (* case 2L *)(* case 1R *)(* case 1R *)
      (* case 3R *)(* case 3R *)(* case 4R *)
      (* case 4R *)(* case 2R *)(* case 2R *)
      (* local *)(* use non-imperative version? *)
      (* : 'a entry option ref *)(* re-color *)
      (* re-color *)) = ref Empty
    let ((insert)(* ignore size hint *)) =
      function
