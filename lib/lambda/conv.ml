  ...
  sig
    val conv :
      (IntSyn.eclo * IntSyn.eclo) ->
        ((bool)(*! structure IntSyn : INTSYN !*)(* Author: Frank Pfenning, Carsten Schuermann *)
...
module Conv(Conv:sig
                   module Whnf :
                   ((WHNF)(* Convertibility Modulo Beta and Eta *)
  ...
  struct
    ...
    let rec convDecP (((D1, P1), s1), ((D2, P2), s2)) =
      convDec ((D1, s1), (D2, s2))
    let ((conv)(*! sharing Whnf.IntSyn = IntSyn' !*)
      (*! structure IntSyn = IntSyn' !*)(* eqUni (L1, L2) = B iff L1 = L2 *)
    ...
    *)
      (* s1 = s2 = id by whnf invariant *)(* order of calls critical to establish convSpine invariant *)
      (* s1' = s2' = ^|G| *)(* they must have the same string representation *)
      (* because of strict *)(* G |- D1[s1] = D2[s2] by typing invariant *)
      (* s1 = id *)(* s2 = id *)(* ABP -- 2/18/03 Added missing case*)
    ...
    *)
      (* convSpine ((S1, s1), (S2, s2)) = B
       ...
       Effects: EVars may be lowered
    *)
      (* bp*)(* no others are possible due to typing invariants *)
      (* convSub (s1, s2) = B
     ...
     Effects: EVars may be lowered
    *)
      (* n = m by invariants *)(* other block cases don't matter -cs 2/18/03 *)
