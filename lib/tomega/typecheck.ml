...
module type TOMEGATYPECHECK  =
  sig
    exception Error of
      ((string)(* Modified: Yu Liao *)(* Author: Carsten Schuermann *)
...
module TomegaTypeCheck(TomegaTypeCheck:sig
                                         ...
                                         ((TOMEGAABSTRACT)(* Type checking for Tomega *)
  ...
  struct
    ...
    let ((checkPrg)(* no other cases can occur *)(*     inferCon (Psi, (H, t)) = (F', t')
    ...
    *)
      (* Psi |- let xx :: F1 = P1 in P2 : F2' *)(* Psi |- t : Psi' *)
      (* Psi' |- F2 for *)(* Psi |- F2' = F2[t] *)
      (* Psi |- F1 :: for *)(* Psi |- P1 :: F1' *)
      (* Psi, D |- P2 :: (F2' [^]) *)(* Psi' |- F2' :: for *)
      (* Psi, D |- t o ^ :: Psi' *)(* Psi |- F1 == F1' for *)
      (* D'' == D *)(* don't forget to check if the worlds match up --cs Mon Apr 21 01:51:58 2003 *)
    ...
    *)
      (* Psi' |- t' :: Psi *)(* convFor (Psi, (F1, t1), (F2, t2)) = ()
   ...
   *)
    ...
    and isValue (T.Lam _) = ()
      ...
      (* ABP 1/23/03 *)) =
      function | (Psi, (P, F)) -> checkPrg (Psi, (P, (F, T.id)))
