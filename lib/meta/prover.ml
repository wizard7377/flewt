...
module type MTPROVER  =
  sig
    module StateSyn :
    ((STATESYN)(* Meta Prover Version 1.3 *)(* Author: Carsten Schuermann *)
...
module CombiProver(CombiProver:sig
                                 ...
                                 module ProverNew :
                                 ((PROVER)(* Meta Theorem Prover Version 1.3 *)
  ...
  struct
    exception Error of
      ((string)(*! structure IntSyn = IntSyn' !*)(*! sharing ProverNew.IntSyn = IntSyn' !*))
